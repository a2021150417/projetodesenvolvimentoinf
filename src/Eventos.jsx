...
import { EVENTS, CATEGORIES, DISTRICTS, SORT_OPTIONS, formatDate } from "./eventsData";
...
export default function Eventos() {
  ...
  const filteredEvents = useMemo(() => {
    ...
    return result;
  }, [search, priceRange, selectedCategories, selectedDistricts, sortBy]);

  const featured = EVENTS.filter((e) => e.trending).slice(0, 3);
  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col">
      ...
      {/* --- NAVBAR INTELIGENTE ADICIONADA AQUI --- */}
