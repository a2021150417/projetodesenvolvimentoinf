...
export default function AdminDashboard() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setEventos(dados.map(e => ({
          ...
          // Guardamos também os dados originais para a edição funcionar perfeitamente
  ...
  // ==========================================
  // FUNÇÕES DE GESTÃO DE EVENTOS (CRIAR/EDITAR/APAGAR)
  // ==========================================
  ...
  const handleGuardarEvento = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        carregarEventos(); // Recarrega a lista atualizada
  ...
  const handleEliminarUtilizador = async (id_utilizador) => {
    ...
    try {
      ...
      if (res.ok) setUtilizadores(utilizadores.filter(u => u.id_utilizador !== id_utilizador));
